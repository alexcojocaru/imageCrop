...
public class ImageFileFilterTest {
	...
	public void testAcceptDirectory() throws AssertionError, IOException {
		...
		try {
			Assert.assertTrue("The image file filter doesn't accept a directory", filter.accept(dir));
		}
	...
	public void testReject() {
		...
		Assert.assertFalse("The image file filter accepts a non-image file", filter.accept(f));
	}
}
