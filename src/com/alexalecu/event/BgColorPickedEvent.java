 ...
 *   the new value
 */
public class BgColorPickedEvent {
	private Color color;
	
	/**
	 * @param color the newly background color selected using the color picker
	 */
	public BgColorPickedEvent(Color color) {
		this.color = color;
	}
	
	/**
	 * @return the newly background color selected using the color picker
	 */
